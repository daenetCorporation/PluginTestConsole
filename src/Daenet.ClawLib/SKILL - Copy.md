...
Before running this script, ensure the following parameters/variables are provided by user. 
...
User can paste the in the conversation chat or provide a file to load them. If the user provides parameters use them as provided.
If the user provides the file load the content of the file by using appropriate tool and attach the content to the prompt. 
Extract required values from the content and map them appropriately.
If parameters are missing ask user to provide them. 
